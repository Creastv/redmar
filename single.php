                    ...
                    <div class="post-contactus">
                        ...
                        <div>
                            <div class="biuro-aria">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/sm-Logo.png"
                                    alt="Redmar Development" />
                                <span>Redmar Developer sp. z o.o.</span>
                            </div>
                            <!-- /.biuro-aria -->
                            <div class="expert-location">
                                <a href="https://www.google.com/maps/search/ul.+1+Maja+3,+05-555+Marianka+(wjazd+od+ul.+Akacjowej)/@51.9802517,20.8041583,17z/data=!3m1!4b1?entry=ttu&g_ep=EgoyMDI1MDkxNi4wIKXMDSoASAFQAw%3D%3D"
                                    target="_blank">
                                    ...
                                    <strong>ul. 1 Maja 3, 05-555 Marianka (wjazd od ul. Akacjowej)</strong>
                                </a>
                            </div>
                            <div class="expert-contact">
                                <a href="tel:+48666343393">
                                ...
                                <a href="mailto:kontakt@redmardevelopment.pl">
                                    <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
